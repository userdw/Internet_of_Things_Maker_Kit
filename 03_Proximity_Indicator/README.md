...
3. Plug the Buzzer Module to the header on the ESP8266 Expansion Shield labelled **5**,
4. Plug the IR Sensor to the header on the ESP8266 Expansion Shield labelled **ADC**,
5. Upload the [Proximity_Indicator](/03_Proximity_Indicator/Proximity_Indicator) code into ESP8266 IoT v2.0.
...
3. Hubungkan Buzzer Module ke header ESP8266 Expansion Shield yang berlabel **5**,
4. Hubungkan IR Sensor ke header ESP8266 Expansion Shield yang berlabel **ADC**,
